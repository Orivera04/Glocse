...
$( document ).ready(function() 
{
            ...
            {                
          	...
          	$( "#sb_reportes" ).click(function() 
          	{
                ...
                {
                    $.Notification.autoHideNotify('error', 'top right', 'Limit the map area first')                                                ;
                }
          	});
 ...
 /********************************************SE LLAMA AL METODO DE ACTUALIZAR PARA LLENAR CAMPOS VACIOS DE DATOS***********************************************************************/
            ...
            {                    
                    ...
                    {                        
                       if(Rectangulo == null)
                       {
                           $.Notification.autoHideNotify('error', 'top right', 'The consumer could not be added as the map has not yet been limited.')                                                
                       }
                       else
                       {
  	...
  	/* Eventos del mapa */            
            ...
            $('#LimitarMapa').click(function(event)
            {
                ...
                {                    
                    ...
                    {
                        DelimitarBordes("");  
                        $.Notification.autoHideNotify('success', 'top right', 'The map has been successfully limited.')                                                
                    }                                  
                    catch(e)
                    {
                        $.Notification.autoHideNotify('warning', 'top right', 'Wait for the map to load.')      
                    }
                }
                else
                {
                    $.Notification.autoHideNotify('warning', 'top right', 'The map has already been previously limited.');                     
                }
            });
            ...
            {                                              
                ...
                {                    
                      ...
                      {
                            DelimitarBordes('2');
                            $.Notification.autoHideNotify('success', 'top right', 'The limitation has been removed from the map.')
                      }
                      else
                      {
                          $.Notification.autoHideNotify('error', 'top right', 'You can not remove the limit of the map have already been set consumers.');
                      }
                }
                else
                {
                    $.Notification.autoHideNotify('warning', 'top right', "The map hasn't been limited yet.");
                }                
            });
            ...
            $('#GuardarEspacioTrabajo').click(function(event)
            {
                  ...
                  $.Notification.autoHideNotify('success', 'top right', 'The workspace has been saved');                
            });
            ...
            {                                              
                ...
                {                    
                      if(Proyecciones[ProyeccionActiva].MarcadoresCollecion.length >= 6)
                      {
                            ...
                            $.Notification.autoHideNotify('success', 'top right', 'The system has calculated the optimum position for the electrical substation.')                                                

                      }
                      else
                      {
                          $.Notification.autoHideNotify('warning', 'top right', 'There is a shortage of at least 6 consumers.At least 6 consumers are needed.');
                      }
                }
                else
                {
              ...
              $('#switchcarga').click(function()
             {
              ...
              $('#switchconsumidores').click(function()
              {
                ...
                if(SwitchActivo('switchconsumidores') == true)
                {
                  if(Rectangulo != null)
                  {
                      $.Notification.autoHideNotify('success', 'top right', 'The consumers found are displayed on the screen'); 
                      MostrarConsumidores(MapaCanvas.getCenter(), MapaCanvas)
                      VerConsumidores(true); 
                  } 
                  else
                  {
                      $.Notification.autoHideNotify('warning', 'top right', 'To search for consumers in the area you need to limit the map first');
                  }               
              ...
              $('#VerProyeccion1').click(function()
                 {                                      
                            ...
                            document.getElementById("botonactiva").innerHTML = 'Projection 1 <span class="m-l-5"><i class=" fa fa-get-pocket"></i></span>';
                            document.getElementById("sidebartexto").innerHTML = "Projection 1";
                ...
                $('#VerProyeccion2').click(function()
                 {                                      
                            ...
                            document.getElementById("botonactiva").innerHTML = 'Projection 2 <span class="m-l-5"><i class=" fa fa-get-pocket"></i></span>';                            
                });
                ...
                $('#VerProyeccion3').click(function()
                 {                                      
                            ...
                            if(SegundaProyeccionActivada == true)
                            {
                                ...
                                document.getElementById("botonactiva").innerHTML = 'Projection 3 <span class="m-l-5"><i class=" fa fa-get-pocket"></i></span>';
                                document.getElementById("sidebartexto").innerHTML = "Projection 3";
                            }
                            else
                            {
                                $.Notification.autoHideNotify('warning', 'top right', 'You have not yet defined the projection two end before continuing.');
                                OcultarMostrar_CentrosDeCargaEventuales(1,ProyeccionActiva,null);
                                OcultarMostrar_Elipses(1 , ProyeccionActiva,null);
                                OcultarMostrar_Cargas(1,ProyeccionActiva,null);
                                ProyeccionActiva = 1;
